      ...
      <div className="border w-11/12 mx-auto border-darkgray bg-white sm:w-7/12 md:w-6/12 lg:w-5/12 xl:w-4/12 mt-12 p-6 rounded-md shadow-md">
        ...
        <form>
          ...
          <Checkbox>
            ...
            <small className="flex-1 text-ash">
          ...
          <LoginBtn>
            ...
            <button className="flex items-center flex-wrap justify-center w-full border border-darkgray px-2 py-2 rounded-sm bg-googleButton bg-lightash hover:bg-white">
